	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer-text-area">
			...
			<div class="theme-info">
				...
				<?php printf( esc_html__( '%1$s Shared by %2$s.', 'listable' ), '<a href="http://themeforest.net/item/listable-a-friendly-directory-wordpress-theme/13398377?ref=pixelgrade" rel="theme">Listable</a>', '<a href="http://www.themes24x7.com/" rel="designer">Themes24x7</a>' ); ?>
			</div>
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
